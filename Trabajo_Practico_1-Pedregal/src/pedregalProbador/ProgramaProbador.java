...
public class ProgramaProbador {
	...
	public static boolean probador() throws Exception{
		...
		String path="F:\\UNLaM\\Programación Avanzada\\GitKraken - Workspace\\Trabajo Practico 1 - Pedregal\\Preparacion de la prueba\\Programa Probador\\Lote de pruebas del programa probador\\Salida esperada\\11.Casa horizontal que entra vertical.out";
		ArchivoSalida archivoSalida= new ArchivoSalida(path);
		path="F:\\UNLaM\\Programación Avanzada\\GitKraken - Workspace\\Trabajo Practico 1 - Pedregal\\Preparacion de la prueba\\Programa Probador\\Lote de pruebas del programa probador\\Entrada\\11.Casa horizontal que entra vertical.in";
